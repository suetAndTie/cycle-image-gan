...
def build_models():
    ...
    image_encoder = CNN_ENCODER_RNN_DECODER(cfg.TEXT.EMBEDDING_DIM, cfg.TEXT)
    # emb_size, hidden_size, vocab_size, rec_unit='lstm', dropout=0.3
...
if __name__ == "__main__":
    ...
    if args.gpu_id == -1: cfg.CUDA = False
    else: cfg.GPU_ID = args.gpu_id
    ...
    if cfg.CUDA: torch.cuda.manual_seed_all(args.manualSeed)
